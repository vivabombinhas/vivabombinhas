    ...
    Tables: {
      ...
      imoveis: {
        Row: {
          ...
          micro_regiao: string | null
          mobiliado: boolean | null
          observacoes: string | null
          observacoes_internas_daniel: string | null
          oculta_para_maria: boolean | null
          origem: Database["public"]["Enums"]["origem_anuncio"] | null
          perfil_lead_ideal: string | null
          ...
          quartos: number | null
          resumo_estrategico_ia: string | null
          status: Database["public"]["Enums"]["status_imovel"]
          suites: number | null
          tags_maria: string[] | null

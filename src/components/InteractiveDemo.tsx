        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative order-1 lg:order-2">
            ...
            <motion.div 
              ...
              className="absolute -bottom-6 right-4 md:-bottom-8 md:-right-12 bg-white/95 backdrop-blur-xl rounded-2xl border border-primary/10 p-5 shadow-[0_20px_50px_rgba(0,0,0,0.1)] w-[240px] md:w-[280px] z-30"
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <span className="text-[10px] font-bold text-primary uppercase tracking-[0.1em] block">Notificação Real</span>
              ...
              <div className="mt-3 pt-3 border-t border-border/40 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-bold text-green-600">Simulação Real</span>
                </div>
              </div>
            </motion.div>
          </div>

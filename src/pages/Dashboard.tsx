    ...
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center p-4">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <h1 className="text-3xl font-bold">Acesse seu Painel</h1>
          <p className="text-muted-foreground">
            Acompanhe suas submissões, edite seus imóveis e veja os interessados que a MarIA encontrou para você.
          </p>
          <div className="flex flex-col gap-3">
            <Button onClick={() => navigate("/anuncie")} size="lg" className="w-full">
              Anunciar Imóvel
            </Button>
          ...
          <p className="text-xs text-muted-foreground">
            Ao anunciar seu primeiro imóvel, criaremos sua conta automaticamente.
          </p>
        </div>
      </div>
    );

...
REGRAS DE CONTEÚDO:
- RESPOSTA EXTREMAMENTE CURTA: Use entre 2 e 4 frases curtas no TOTAL ABSOLUTO. É proibido ultrapassar 4 frases. No máximo 1 lista de até 3 bullets se essencial. Jamais escreva parágrafos longos.
...
Deno.test("Consultive Mode: Short sentence count check (2-4 sentences)", async () => {
  ...
  for (const input of testCases) {
    ...
    assert(sentences <= 4, `Should have at most 4 sentences. Got: ${sentences}\nReply: ${reply}`);
